...
declare function encode(ver: Version, ecc: ErrorCorrection, data: string, type: EncodingType, encoder?: (value: string) => Uint8Array): Uint8Array;
declare function drawQR(ver: Version, ecc: ErrorCorrection, data: Uint8Array, maskIdx: Mask, test?: boolean): Bitmap;
declare function penalty(bitmap: Bitmap): number;
